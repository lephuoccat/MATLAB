...
% Last Modified by GUIDE v2.5 15-May-2013 16:32:46
...
set(handles.text3,'string',sprintf('The answer is: A'));
...
set(handles.text3,'string',sprintf('The answer is: B'));
...
set(handles.text3,'string',sprintf('The answer is: C'));
set(handles.radiobutton1,'value',0);
set(handles.radiobutton2,'value',0);
